...
printf("no precision:   |%f|\n", f);
	...
	printf("------------------------------LENGTH SIZES------------------------\n");
	printf("char:				%zu,	%d\n", sizeof(char), 1<<7);
	printf("unsigned char:			%zu,	%d\n", sizeof(unsigned char), (1<<8));
	printf("short:				%zu,	%d\n", sizeof(short), 1<<15);
	printf("unsigned short:			%zu,	%d\n", sizeof(unsigned short), ~(1<<16));
	printf("long:				%zu,	%d\n", sizeof(long), 1<<31);
	printf("unsigned long:			%zu,	%d\n", sizeof(unsigned long), 1<<32);
	printf("long long:			%zu,	%d\n", sizeof(long long), 1<<63);
	printf("unsigned long long:		%zu,	%d\n", sizeof(unsigned long long), 1<<64);
	printf("intmax_t:			%zu\n", sizeof(intmax_t));
	printf("uintmax_t:			%zu\n", sizeof(uintmax_t));
	printf("size_t:				%zu\n", sizeof(size_t));
	printf("ssize_t:			%zu\n", sizeof(ssize_t));
